...
export default function Portfolio() {
 ...
 <div className="hero-diagram" aria-hidden="true"><svg viewBox="0 0 300 210"><path d="M15 20H70Q90 20 90 40V85Q90 110 115 110H235Q260 110 260 135V180" fill="none" stroke="#444" strokeWidth="1.3"/><path d="M15 20H70Q90 20 90 40V85Q90 110 115 110H190" fill="none" stroke="#ff5200" strokeWidth="2"/><circle cx="15" cy="20" r="4" fill="#ff5200"/><circle cx="190" cy="110" r="5" fill="#ff5200"/><circle cx="260" cy="180" r="4" fill="#050505" stroke="#777"/><text x="14" y="47">DATABASES</text><text x="191" y="92">PRODUCT</text><text x="219" y="205">WHAT’S NEXT?</text></svg><span className="diagram-caption">[ A CONTINUOUS EVOLUTION ]</span></div>
